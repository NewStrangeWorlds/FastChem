...
\documentclass[numbers=noenddot]{fcmanual}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, language={}, frame=single]{code/element_abundances_solar.dat}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, language={}, frame=single]{code/logK_sample.dat}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, language={}, frame=single]{code/chemical_elements.dat}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, language={}, frame=single]{code/parameters.dat}
...
\lstinputlisting[basicstyle=\ttfamily\scriptsize, language={}, frame=single]{code/config.input}
...
\section{Sample input and output files}
