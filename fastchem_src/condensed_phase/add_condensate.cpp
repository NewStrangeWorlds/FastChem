...
void FastChem<double_type>::addCondensate(const std::string name, const std::string symbol,
                                          const std::vector<std::string> species_elements, const std::vector<int> stoichiometric_coeff,
                                          const double_type density, const std::string phase, 
                                          const std::vector<double>& phase_temp_limits, const std::vector<double>& fit_temp_limits,
